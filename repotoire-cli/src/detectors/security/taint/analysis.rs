...
//!
//! Contains `TaintAnalyzer` (the main analysis engine), and integration helpers
//! (`run_intra_function_taint`, `taint_path_to_finding`) used by security detectors.

use super::heuristic;
use super::types::{word_boundary_match, TaintCategory, TaintPath};
use crate::graph::{GraphQuery, GraphQueryExt, NodeKind};
