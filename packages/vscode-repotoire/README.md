...
The extension launches `repotoire lsp` as a Language Server Protocol backend. The LSP server runs repotoire's full analysis pipeline (110 detectors, graph-based) and streams diagnostics to VS Code as you edit.
...
Repotoire runs 77 default detectors covering:
