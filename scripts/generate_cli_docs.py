...
def generate_full_docs(output: TextIO | None = None) -> str:
    ...
    lines.append("|----------|-------------|")
    lines.append("| `REPOTOIRE_NEO4J_URI` | Neo4j connection URI (e.g., bolt://localhost:7687) |")
    lines.append("| `REPOTOIRE_NEO4J_PASSWORD` | Neo4j password |")
    lines.append("| `REPOTOIRE_NEO4J_USER` | Neo4j username (default: neo4j) |")
    lines.append("| `REPOTOIRE_DB_TYPE` | Database type (neo4j or falkordb) |")
    ...
    lines.append('user = "neo4j"')
    lines.append('password = "${NEO4J_PASSWORD}"  # Environment variable interpolation')
    lines.append("")
