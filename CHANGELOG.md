...
## [0.7.0](https://github.com/Zach-hammad/repotoire/compare/v0.6.0...v0.7.0) (2026-04-16)


### Features

* add AnalysisContext and ScanMode types ([5740e04](https://github.com/Zach-hammad/repotoire/commit/5740e047c8970a5ba49edf7f9fdeb205dc4a93cd))
* add baseline fingerprint module with entity, multi-entity, file-level hashing ([82b99ee](https://github.com/Zach-hammad/repotoire/commit/82b99ee2387d554af08e2e547fa78f5f78f39e08))
* add baseline load/save/match with dedup and prune ([ce58966](https://github.com/Zach-hammad/repotoire/commit/ce5896667841dfc713987589e81180469ccff7b1))
* add confidence scoring to N+1 detector with severity adjustment ([9631d1b](https://github.com/Zach-hammad/repotoire/commit/9631d1b35008f02c821629dc1f832f5cdee0a5dd))
* add confidence_threshold to detector config overrides ([f90dc24](https://github.com/Zach-hammad/repotoire/commit/f90dc24ece01556395ab3b71ec420000bbfaaa60))
* add consumer pattern exemptions to N+1 detector (Phase 0.5) ([58efcc5](https://github.com/Zach-hammad/repotoire/commit/58efcc56e1d8356bdcb983ce7f2cb4eb6deed2a8))
* add graph-aware delta detection — changed node mapping and impact walk ([1738e4c](https://github.com/Zach-hammad/repotoire/commit/1738e4c788872f34c25440c10b3fe4e42ff0be9b))
* add merge-base LCA algorithm to pure Rust git implementation ([4eb010d](https://github.com/Zach-hammad/repotoire/commit/4eb010da5a8708c78ae748ee2a6fe45c20a5dd7a))
* add post-detection filter stage for baseline, config overrides, attribution ([cd40a1c](https://github.com/Zach-hammad/repotoire/commit/cd40a1c0a19ce801fec557ea64fb81efd1a2ea01))
...
* apply session persistence infrastructure from stash ([8b187ff](https://github.com/Zach-hammad/repotoire/commit/8b187ff3a4889dabdbb6cc75639230854435bbc6))
...
* **cli:** wire up baseline command (update, add, prune) ([ea44303](https://github.com/Zach-hammad/repotoire/commit/ea44303a6aaa423cc7cc83442087516aa397b8b5))
* complete commit-aware analysis pipeline ([04b81e1](https://github.com/Zach-hammad/repotoire/commit/04b81e1a38c2e2780f402e225a50e4038c058bc4))
...
* **detectors:** top-10 slowest-detector summary in runner ([1b04715](https://github.com/Zach-hammad/repotoire/commit/1b04715cb887481df6e7accc0bc09e8487ff02e1))
...
* **engine:** wire baseline loading into filter stage ([3cce59e](https://github.com/Zach-hammad/repotoire/commit/3cce59e703cf6c2eca0d60a4b522098cec92291c))
...
* **git/raw:** add commit and tree parsers ([ede36b4](https://github.com/Zach-hammad/repotoire/commit/ede36b406eb9b81d88748f82d4d5fcb46bdaac52))
* **git/raw:** add DEFLATE decompressor (RFC 1951) ([3ce80bb](https://github.com/Zach-hammad/repotoire/commit/3ce80bbff33027e6e91d6882c3b278b72257c838))
* **git/raw:** add line-level blame algorithm ([7f330bf](https://github.com/Zach-hammad/repotoire/commit/7f330bf801a1fe2dcf1b49d5d6417ef4be03e584))
* **git/raw:** add loose object reader ([3629558](https://github.com/Zach-hammad/repotoire/commit/3629558caca0f6611ea1e3faa7ed42a446af267c))
* **git/raw:** add pack index v2 reader ([3424efe](https://github.com/Zach-hammad/repotoire/commit/3424efe45a7090f9e433bc8b91dbcb7f2cfcc22d))
* **git/raw:** add packfile reader with delta reconstruction ([ebdee83](https://github.com/Zach-hammad/repotoire/commit/ebdee831016006830420b8d2dd97d2fbb25184f2))
* **git/raw:** add RawRepo with discovery, refs, and object lookup ([43f7504](https://github.com/Zach-hammad/repotoire/commit/43f75049501f977c26e9cc434f0501fb9640a5ec))
* **git/raw:** add SHA-1 implementation (RFC 3174) ([137ee98](https://github.com/Zach-hammad/repotoire/commit/137ee98e060e533546e2093dbe6d5e3bd62aab23))
* **git/raw:** add time-sorted revwalk ([1959684](https://github.com/Zach-hammad/repotoire/commit/1959684ddaad22d71e53821ff63855f313ba16df))
* **git/raw:** add tree-to-tree diff with Myers blob diff ([f72b75a](https://github.com/Zach-hammad/repotoire/commit/f72b75a35c4ba74f4ceb1ce169e1710e4952be48))
* **git/raw:** finalize public API surface in mod.rs ([28d0131](https://github.com/Zach-hammad/repotoire/commit/28d0131f09bed73e98fbe5ee7a80d78ef28cb00d))
* **git/raw:** scaffold module with error type and OID ([af99e92](https://github.com/Zach-hammad/repotoire/commit/af99e9244b8cd87a9226adf44172f113834cd3c9))
* **graph:** add hand-rolled Tarjan SCC, dominators, and WeightedOverlay ([3934e8b](https://github.com/Zach-hammad/repotoire/commit/3934e8b42a82becadf36e0fd957e20537a8d1ea5))
* **graph:** add NodeIndex newtype (replaces petgraph NodeIndex) ([693e3aa](https://github.com/Zach-hammad/repotoire/commit/693e3aa59b521a61b0fea6d646287fe18fae6e65))
* **graph:** enable BFS vertex reordering at freeze time ([5525afd](https://github.com/Zach-hammad/repotoire/commit/5525afde213721fc7f89e85a2d079e8c99872efe))
* **graph:** hand-roll string interner (replace lasso) ([d8102a9](https://github.com/Zach-hammad/repotoire/commit/d8102a95946cc481ee2a90851cc878aa8517ca6e))
...
* **models:** add FindingStatus, Attribution, and Confidence enums ([506f45a](https://github.com/Zach-hammad/repotoire/commit/506f45adc6f206bd37bab29c9ab53670ac9b98bb))
* **parsers:** log tree-sitter ERROR nodes at debug level ([bf5f218](https://github.com/Zach-hammad/repotoire/commit/bf5f218a3d4ac20e2728cce6b6b9d0331d1505d3))
...
* wire filter stage into engine pipeline between postprocess and score ([8989f58](https://github.com/Zach-hammad/repotoire/commit/8989f581d1154ae0a1bcb4320cd440308b956248))


### Bug Fixes

* **analyze:** write .last_used marker in the real cache dir on startup ([f13c23d](https://github.com/Zach-hammad/repotoire/commit/f13c23d75a1139ce5439822c5ca28985f1069fe2))
* **blame:** key cache by content hash, persist on save_cache, check disk on miss ([3dc6b0c](https://github.com/Zach-hammad/repotoire/commit/3dc6b0c90a11b94a97e090b53b723300f3714016))
* **cache:** cap incremental cache file map with oldest-first eviction ([12d6b36](https://github.com/Zach-hammad/repotoire/commit/12d6b3684a93f2a668f373acc6fc1e3ff92bf920))
...
* **engine:** propagate rayon thread-pool build failure instead of panicking ([f97f9c2](https://github.com/Zach-hammad/repotoire/commit/f97f9c23f8c2f6ccd42ac69b29ad44f041a0872e))
...
* **graph,taint:** tolerate mutex poisoning in append-only accumulators ([b77252f](https://github.com/Zach-hammad/repotoire/commit/b77252f237e78ffb0f1faeeb9f75d4232052f70c))
...
* remove remaining petgraph references missed during merge to main ([7c3d0f4](https://github.com/Zach-hammad/repotoire/commit/7c3d0f41dfb143dccb34743ca61fba836f453c71))
* resolve clippy warnings in filter stage and engine docs ([8903d8a](https://github.com/Zach-hammad/repotoire/commit/8903d8aa00db0e68043a1455e10bfda3ab84a4e8))
...
* **blame:** cap commit walk depth at 500 per file ([eb7a60d](https://github.com/Zach-hammad/repotoire/commit/eb7a60db59cac8ca246ab8840d24dd1db53d51b9))
* **blame:** share Arc&lt;RawRepo&gt; across prewarm_cache workers ([e55cbd7](https://github.com/Zach-hammad/repotoire/commit/e55cbd701c8b3aefc169658e387c1d9b401a6055))
* **build:** enable jemalloc as default allocator feature ([ea3bc29](https://github.com/Zach-hammad/repotoire/commit/ea3bc291b7f7091808c29fc6b5959cf9215d5611))
* **circular-dep:** reify import edges and hoist suffix strings ([5429df0](https://github.com/Zach-hammad/repotoire/commit/5429df01dddb2ec5eceafcb930544ced41b90ab4))
* **co-change:** early-exit commit walk when decay falls below threshold ([fd4fb28](https://github.com/Zach-hammad/repotoire/commit/fd4fb288cdb4abe9687a71dd6cd09e8e81dd1a35))
* **co-change:** skip blob decompression co_change throws away ([e8eab2e](https://github.com/Zach-hammad/repotoire/commit/e8eab2e2a790a6820c0dd409b4d1fe28baa2bcc3))
* **dead-code:** hoist per-class allocations out of the import-edge scan ([0dea98b](https://github.com/Zach-hammad/repotoire/commit/0dea98b74ae12bea1507ee2120f415dc8262b338))
* **engine:** parallelize git_enrich sub-stages and add per-stage timings ([97e350f](https://github.com/Zach-hammad/repotoire/commit/97e350fe086a1ff45a60d6baad40441e54f59847))
* **git/raw:** replace Mutex&lt;LruCache&gt; with concurrent DashMap ([75af337](https://github.com/Zach-hammad/repotoire/commit/75af337f947d6979522230b3bd746f9fc5f81a2c))
* **git:** skip vendor/node_modules/lockfiles from blame prewarm ([f8e5aec](https://github.com/Zach-hammad/repotoire/commit/f8e5aecc652aa7b91680fc28d7ab04e6b7ac8e2e))
...
* enhanced version output with build info, remove stale action.yml ([b9cbe47](https://github.com/Zach-hammad/repotoire/commit/b9cbe4784414044d57b2250ff4025e4b2e61aa3d))
