...
class PRDescriptionGenerator:
    ...
    def generate(self, fix_batch: FixBatch, test_results: Optional[Dict] = None) -> str:
        ...
        desc += "- 📚 Code quality standards\n"
        desc += "- 🔍 Similar patterns in codebase\n"
        desc += "- 🤖 AI analysis with RAG context\n\n"
        ...
        if test_results:
            ...
            if test_results.get("passed"):
                ...
                desc += f"- ✅ {test_results.get('test_count', 0)} tests passed\n"
            else:
                desc += "- ⚠️ Some tests failed\n"
                desc += f"- ❌ {test_results.get('failed_count', 0)} tests failed\n"
        ...
        # Footer
        desc += "---\n\n"
        desc += f"🤖 Generated by **Repotoire Auto-Fix** on {datetime.now().strftime('%Y-%m-%d %H:%M UTC')}\n"
