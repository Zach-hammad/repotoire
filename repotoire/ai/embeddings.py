"""Code-aware embedding generation using Neo4j GraphRAG."""
...
class CodeEmbedder:
    ...
    Uses Neo4j GraphRAG's OpenAIEmbeddings under the hood but adds
    code-specific context enrichment for better semantic understanding.
    ...
    def __init__(
        ...
        logger.info(
            f"Initialized CodeEmbedder with model={self.config.model}, "
