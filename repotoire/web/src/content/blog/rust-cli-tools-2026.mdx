...
Analyzing: /path/to/your/repo
  ...
  Detectors: 110 (77 default + 33 deep-scan)
...
Under the hood, it parses code with [tree-sitter](https://tree-sitter.github.io/tree-sitter/), builds an in-memory graph with [petgraph](https://docs.rs/petgraph/), and runs 110 pure Rust detectors in parallel via [rayon](https://docs.rs/rayon/). It supports 9 graph-native languages (Python, TypeScript, JavaScript, Rust, Go, Java, C#, C, C++), outputs in 5 formats (text, JSON, HTML, SARIF, Markdown), and the [GitHub Action](https://github.com/Zach-hammad/repotoire-action) integrates it into your PR workflow.
