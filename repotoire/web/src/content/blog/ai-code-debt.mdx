...
Repotoire runs 110 detectors, six of which specifically target AI-generated code patterns. They work by analyzing the structure of your codebase as a graph — functions, classes, imports, and their relationships — then applying algorithms that surface patterns invisible to file-by-file analysis.
