...
export const metadata = {
  ...
  description: "Get Repotoire running and analyze your first codebase in under 5 minutes",
}
...
- [REST API](/docs/api/overview) - Programmatic access
- [Webhooks](/docs/webhooks/overview) - Real-time notifications
