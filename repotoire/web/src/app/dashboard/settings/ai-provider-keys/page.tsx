...
export default function AIProviderKeysPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight flex items-center gap-2">
            AI Provider Keys
            <HelpTooltip content="Your own API keys for AI fixes (BYOK)" />
          </h1>
          <p className="text-muted-foreground">
      ...
      {/* Info Card */}
      <Card className="border-info-semantic/20 bg-info-semantic-muted" size="compact">
        <CardContent>
          <div className="flex items-start gap-3">
            <Sparkles className="h-5 w-5 text-info-semantic mt-0.5" />
