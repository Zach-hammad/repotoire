  ...
  const severityItems = [
    {
      ...
      icon: AlertTriangle,
      className: 'border-error/20 bg-error-muted text-error',
    },
    {
      label: 'High',
      count: summary.high,
    ...
    <div className="space-y-4">
      <div className="grid gap-4 md:grid-cols-5">
        {severityItems.map(({ label, count, icon: Icon, className }) => (
          <Card key={label} className={cn('border', className.split(' ').filter(c => c.startsWith('border-')).join(' '))} size="compact">
                ...
                <div className="flex-1">
                  <Badge
                    ...
                    className={cn(
                      ...
                      queryResult.confidence === 'low' && 'bg-muted text-muted-foreground'
                    )}
                  >
          ...
          <Card>
            ...
            <CardContent>
              {repo.repository_id ? (
                ...
                <div className="text-center py-8 text-muted-foreground">
                  <CheckCircle2 className="mx-auto h-12 w-12 text-muted-foreground mb-3" aria-hidden="true" />
            ...
            <Card>
              <CardContent className="py-12">
                <div className="text-center text-muted-foreground">
                  <GitCommit className="mx-auto h-12 w-12 text-muted-foreground mb-3" aria-hidden="true" />
