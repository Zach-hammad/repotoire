    ...
    <div className="grid gap-4 md:grid-cols-4">
        ...
        <CardContent className="pt-4 pb-4">
          <div className="flex items-center gap-3">
            <div className="p-2 rounded-lg bg-info-muted">
              <GitBranch className="h-5 w-5 text-info-semantic" />
            </div>
            <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className={`text-2xl font-bold ${
                  ...
                  stats.avgHealth >= 80 ? 'text-success' :
                  stats.avgHealth >= 60 ? 'text-warning' : 'text-error'
                }`}>
      ...
      {stats.needsAttention > 0 && (
        <GlowWrapper color="amber" intensity="medium" className="rounded-xl">
          <HolographicCard variant="subtle" className="h-full border-warning/30">
    ...
    return (
      <HolographicCard variant="glass" className="overflow-hidden">
        <div className="relative p-8">
          {/* Background gradient */}
          <div className="absolute inset-0 bg-gradient-to-r from-muted/5 via-primary/5 to-primary/5" />
            ...
            <AnimatePresence mode="popLayout">
              {convertedRepos.map((convertedRepo) => (
                ...
                >
                  <RepoCard
                    repo={convertedRepo}
                    installationId={convertedRepo._installationId}
                    onUpdate={loadData}
                  />
                </motion.div>
              ))}
