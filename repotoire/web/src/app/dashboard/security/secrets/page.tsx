        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className={cn(
                'text-2xl font-bold',
                scanResult.total_secrets_found > 0 ? 'text-error' : 'text-success'
              )}>
