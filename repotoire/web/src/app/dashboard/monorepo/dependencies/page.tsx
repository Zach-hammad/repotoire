...
const packageTypeColors: Record<string, string> = {
  npm: 'bg-warning-muted text-warning border-warning',
  yarn: 'bg-info-semantic-muted text-info-semantic border-info-semantic',
  ...
  poetry: 'bg-success-muted text-success border-success',
  cargo: 'bg-error-muted text-error border-error',
          ...
          {affectedResult && (
            <div className="space-y-4">
              ...
              <div className="grid gap-4 md:grid-cols-4">
                ...
                <div className="p-4 rounded-lg bg-info-muted">
                  <div className="text-sm text-muted-foreground">Total to Build</div>
                  <div className="text-2xl font-bold text-info-semantic">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {affectedResult.changed_packages.map((pkg) => (
                      <Badge key={pkg} variant="outline" className="bg-warning-muted text-warning border-warning">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                {graphResult.nodes.map((node) => {
                  ...
                  const colorClass = packageTypeColors[node.type] || 'bg-muted text-muted-foreground border-border';
