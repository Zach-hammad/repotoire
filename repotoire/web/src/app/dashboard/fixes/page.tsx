          ...
          <div className="relative flex items-start justify-between">
            ...
            <div className="hidden lg:flex items-center gap-6">
              ...
              <GlowWrapper color="green" intensity="low" className="rounded-lg">
                <div className="bg-card/80 backdrop-blur-sm rounded-lg px-4 py-2 border border-border/50">
                  <div className="text-2xl font-bold text-success">{summaryStats.applied}</div>
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <div>
              <div className="flex items-center gap-1.5 mb-1.5">
                ...
                <HelpTooltip content="How confident the AI is in this fix. High = safe to apply" iconClassName="h-3 w-3" />
              </div>
              <Select
            ...
            <div>
              <div className="flex items-center gap-1.5 mb-1.5">
                <span className="text-xs font-medium text-muted-foreground">Fix Type</span>
                <HelpTooltip content="Refactor, Simplify, Extract, Rename, Remove" iconClassName="h-3 w-3" />
              </div>
              <Select
            ...
            <TableHeader>
              <TableRow>
                ...
                <TableHead
                  ...
                  onKeyDown={(e) => (e.key === 'Enter' || e.key === ' ') && handleSortChange('created_at')}
                  role="button"
                  tabIndex={0}
                >
                ...
                <TableHead
                  ...
                  onKeyDown={(e) => (e.key === 'Enter' || e.key === ' ') && handleSortChange('confidence')}
                  role="button"
                  tabIndex={0}
                >
                  <div className="flex items-center gap-2">
                ...
                <TableHead
                  ...
                  onKeyDown={(e) => (e.key === 'Enter' || e.key === ' ') && handleSortChange('status')}
                  role="button"
                  tabIndex={0}
                >
                  <div className="flex items-center gap-2">
              ...
              {isLoading ? (
                ...
                <TableRow>
                  <TableCell colSpan={8} className="h-48">
                    <EmptyState
                      variant={hasActiveFilters ? "search" : "getting-started"}
                      title={hasActiveFilters ? "No Fixes Match Filters" : "No AI Fixes Yet"}
                      description={hasActiveFilters 
                        ? "Try adjusting your filters to find what you're looking for."
                        : "Run analysis on a repository to generate AI-powered fix suggestions."
                      }
                      action={hasActiveFilters 
                        ? { label: "Clear Filters", onClick: clearFilters }
                        : { label: "View Repositories", href: "/dashboard/repos" }
                      }
                      size="sm"
                    />
                  </TableCell>
