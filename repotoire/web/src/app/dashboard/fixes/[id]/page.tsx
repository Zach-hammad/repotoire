...
const confidenceBadgeColors: Record<FixConfidence, string> = {
  high: 'bg-success-muted text-success border-success',
  medium: 'bg-warning-muted text-warning border-warning',
  low: 'bg-error-muted text-error border-error',
};

const statusBadgeColors: Record<FixStatus, string> = {
  pending: 'bg-warning-muted text-warning border-warning',
  approved: 'bg-info-semantic-muted text-info-semantic border-info-semantic',
  rejected: 'bg-error-muted text-error border-error',
  applied: 'bg-success-muted text-success border-success',
  failed: 'bg-warning-muted text-warning border-warning/20',
      ...
      <div className="flex items-start justify-between">
        <div className="space-y-1">
          <div className="flex items-center gap-2">
            <Link href="/dashboard/fixes">
              <Button variant="ghost" size="icon" aria-label="Back to fixes">
          ...
          <div className="flex items-center gap-2 ml-10">
            <Tooltip>
              ...
              <TooltipContent className="max-w-xs">
                ...
                <p className="text-xs text-success mt-2">Next: {statusConfig[fix.status].nextAction}</p>
              </TooltipContent>
            </Tooltip>
            <Tooltip>
              <TooltipTrigger asChild>
        ...
        <div className="flex items-center gap-2">
          ...
          {canApprove && (
            <Button
              ...
              className={!hasRunPreview ? 'bg-info-semantic hover:bg-info-semantic/90' : ''}
            >
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-4">
                  ...
                  <div key={step.step} className="flex items-center">
                    <div className={cn(
                      ...
                      <div className={cn(
                        ...
                        step.status === 'completed' && 'bg-success-muted text-success',
                        step.status === 'current' && 'bg-info-semantic-muted text-info-semantic ring-2 ring-info-semantic/50',
                      ...
                      <p className={cn(
                        ...
                        step.status === 'current' && 'font-medium text-info-semantic',
          ...
          {canApprove && !hasRunPreview && (
            <div className="flex items-center gap-3 p-4 rounded-lg bg-info-semantic-muted border border-info-semantic">
              <Eye className="h-5 w-5 text-info-semantic shrink-0" />
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-info-semantic">
              ...
              <Button
                ...
                onClick={handlePreview}
                disabled={isPreviewing}
                className="shrink-0 border-info-semantic text-info-semantic hover:bg-info-semantic-muted"
              >
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className={fix.syntax_valid ? 'text-success' : 'text-error'}>
