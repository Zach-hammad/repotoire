...
// Mock data for React health report
const healthData = {
  repo: {
    name: 'facebook/react',
  ...
  topIssues: [
    {
      severity: 'critical',
      title: 'Potential ReDoS vulnerability in regex pattern',
      file: 'packages/react-dom/src/shared/sanitizeURL.js',
      detector: 'Security',
    },
    {
      severity: 'critical',
    ...
    {
      severity: 'high',
      title: 'Cyclomatic complexity of 42 exceeds threshold (15)',
      file: 'packages/react-dom/src/client/ReactDOMComponent.js',
      detector: 'Complexity',
    },
    {
      severity: 'high',
      title: 'Function has 12 parameters (max: 5)',
      file: 'packages/react-reconciler/src/ReactChildFiber.js',
      detector: 'Code Style',
    },
    {
      severity: 'medium',
      title: 'Duplicate code block detected (85% similarity)',
      file: 'packages/react-dom/src/events/...',
      detector: 'Duplication',
    },
  ],
  fileHotspots: [
    { file: 'ReactDOMComponent.js', count: 18, path: 'packages/react-dom/src/client/' },
    { file: 'ReactFiberWorkLoop.js', count: 15, path: 'packages/react-reconciler/src/' },
    { file: 'ReactChildFiber.js', count: 12, path: 'packages/react-reconciler/src/' },
    { file: 'DOMPropertyOperations.js', count: 9, path: 'packages/react-dom/src/client/' },
    { file: 'ReactFiberCommitWork.js', count: 8, path: 'packages/react-reconciler/src/' },
  ],
  detectorBreakdown: [
    { name: 'Complexity', count: 34, color: '#8b5cf6' },
    { name: 'Code Style', count: 28, color: '#3b82f6' },
    { name: 'Duplication', count: 25, color: '#10b981' },
    { name: 'Security', count: 12, color: '#ef4444' },
    { name: 'Error Handling', count: 18, color: '#f59e0b' },
    { name: 'Dead Code', count: 15, color: '#6b7280' },
    { name: 'Type Safety', count: 10, color: '#ec4899' },
  ],
};
...
export const metadata = {
  title: 'React Health Report | Repotoire',
  description: 'Code health analysis report for facebook/react - The React JavaScript library.',
};

export default function ReactSamplePage() {
  return (
