...
// Lazy load the trends chart (severity trends over time)
export const LazyTrendsChart = dynamic(
  () => import('@/components/dashboard/trends-chart'),
  {
    loading: () => <ChartSkeleton height={300} />,
    ssr: false,
  }
...
// Lazy load the detector chart (findings by detector)
export const LazyDetectorChart = dynamic(
  () => import('@/components/dashboard/detector-chart'),
  {
