...
const severityConfig: Record<Severity, {
  ...
  critical: {
    ...
    bgColor: 'bg-[var(--severity-critical)]',
    label: 'Critical',
    icon: AlertOctagon,
  },
  high: {
    color: 'var(--severity-high)',
    bgColor: 'bg-[var(--severity-high)]',
    label: 'High',
    icon: AlertTriangle,
  },
  medium: {
    color: 'var(--severity-medium)',
    bgColor: 'bg-[var(--severity-medium)]',
    label: 'Medium',
    icon: AlertCircle,
  },
  low: {
    color: 'var(--severity-low)',
    bgColor: 'bg-[var(--severity-low)]',
    label: 'Low',
    icon: CheckCircle2,
  },
  info: {
    color: 'var(--severity-info)',
    bgColor: 'bg-[var(--severity-info)]',
    label: 'Info',
    icon: Info,
  },
};
  ...
  return (
    <div className={cn('flex items-center gap-2', className)}>
      ...
      <span
        className={cn(
          'text-xs font-medium',
          trend > 0 ? 'text-error' : trend < 0 ? 'text-success' : 'text-muted-foreground'
        )}
      >
