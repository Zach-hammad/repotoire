...
const confidenceBadgeVariants: Record<ProvenanceConfidence, string> = {
  ...
  low: 'bg-orange-500/10 text-orange-700 border-orange-500/20 dark:text-orange-400',
  unknown: 'bg-gray-500/10 text-gray-700 border-gray-500/20 dark:text-gray-400',
};
      ...
      <PopoverTrigger asChild>
        <Badge
          ...
          className={cn(
            ...
            origin.user_corrected && 'border-blue-500/50',
            className
          )}
        >
