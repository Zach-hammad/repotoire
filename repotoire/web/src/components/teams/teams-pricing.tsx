    ...
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/30 border-t border-border/50">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-12 p-6 rounded-xl bg-emerald-500/5 border border-emerald-500/20 flex flex-col sm:flex-row items-center justify-between gap-4"
        >
          ...
          <Link href="/cli">
            <Button variant="outline" className="border-emerald-500/30 hover:bg-emerald-500/5">
              Download CLI
            </Button>
          </Link>
        </motion.div>
