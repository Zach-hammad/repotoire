        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
              ...
              <br />
              <span className="font-serif italic text-muted-foreground">can't see.</span>
            </h1>
            ...
            <div className={`flex items-center gap-6 opacity-0 ${isVisible ? "animate-fade-up delay-300" : ""}`}>
              <a
