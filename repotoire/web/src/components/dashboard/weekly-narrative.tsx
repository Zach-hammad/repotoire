...
const highlightColors: Record<HighlightType, string> = {
  ...
  regression: 'text-error',
  new_issue: 'text-warning',
  resolved: 'text-info-semantic',
};
...
function MetricsComparisonRow({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 py-2 border-y border-border/50">
